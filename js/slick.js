...
(function(factory) {
   ...
   /*       _.$slides.not(_.$slideTrack.find('.slick-cloned')).each(function(i) {
         ...
         -- --- ---- ---- ----- ----- ---------       ----------   закоментил из-за валидатора*/
        if (_.$dots !== null) {
            _.$dots.attr('role', 'tablist').find('li').each(function(i) {
                $(this).attr({
                    'role': 'presentation',
                    /*'aria-selected': 'false',
                    'aria-controls': 'navigation' + _.instanceUid + i + '', --- ---- ----- -----   закоментил из-за валидатора*/
                    'id': 'slick-slide' + _.instanceUid + i + ''
                });
            })
                /*.first().attr('aria-selected', 'true').end()
                .find('button').attr('role', 'button').end()  закоментил из-за валидатора*/
